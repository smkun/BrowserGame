...
function playGame(playerChoice) {
    ...
    const choiceImageMap = {
        lapis: "/ASSETS/lapis.png",
        papyrus: "ASSETS/papyrus.png",
        scalpellus: "/ASSETS/scalpellus.png",
    };
    document.getElementById(
        "anubisChoiceImage"
    ...
    if (resultMessage === "You win!") {
        outcomeImageFile = "/ASSETS/AnubisAngry.png";
        outcomeText = "Anubis ANGRY!!";
    } else if (resultMessage === "It's a tie!") {
        outcomeImageFile = "/ASSETS/AnubisSad.png";
        outcomeText = "Anubis sad.";
    } else if (resultMessage === "Anubis wins!") {
        outcomeImageFile = "/ASSETS/AnubisHappy.png";
